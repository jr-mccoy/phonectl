...
from droidjig import audit, errors, observer, policy, results, trust
from droidjig.daemon import PROTOCOL_VERSION
from droidjig.daemon import rpc as rpc_mod
from droidjig.daemon.discovery import LOOPBACK
from droidjig.daemon.events import EventBus
from droidjig.daemon.jobs import JobRegistry
...
class DaemonServer:
    ...
    def _register_builtins(self) -> None:
        ...
        # action (Finding 1). Resume via `droidjig resume` on the host or the
        ...
        from droidjig.macro import schema as _mschema
        ...
        from droidjig.macro import registry as _mreg
        ...
        from droidjig.macro import autonomy as _aut
        from droidjig.macro import memory as _mem
        import time as _t
        ...
        def _events_poll(params, ctx):
            ...
            try:
                if getattr(self, "_trigger_mgr", None) is None:
                    from droidjig.daemon.triggers import TriggerManager, Scheduler
                    from droidjig.macro.engine import Engine as _Eng
    ...
    def _run_act(self, params):
        ...
        from droidjig.daemon import records as _records
        ...
        try:
            from droidjig.macro import memory as _memory
            ...
            if not trust.tokens_equal(req.get("token"), self._token):
                return self._finish(
                    results.err(
                        ...
                        user_action="Use the droidjig CLI/MCP on this host; other "
    ...
    def _fn_for(self, params):
        from droidjig import actuator, audit
        verb = params["verb"]
        target = params.get("target")
