...
import com.phonectl.companion.json.Ocr
import com.phonectl.companion.json.OcrRegion
 ...
 *
 * Precedence: the Python `OcrProvider` (src/phonectl/providers/ocr.py) is **tesseract-first** — its
...
object OcrHandler {
     ...
     * method in the dispatcher via [com.phonectl.companion.state.Capabilities.methodGate], not here.
     */
