package com.droidjig.companion.ui
...
import com.droidjig.companion.service.CompanionForegroundService
import com.droidjig.companion.service.CompanionNotificationListenerService
...
class SettingsActivity : AppCompatActivity() {
    ...
    // Runtime request for POST_NOTIFICATIONS (API 33+). Without it the "Stop droidjig" foreground
    // notification silently never appears when the app is installed without running
    // `droidjig companion setup` (the manifest <uses-permission> alone does not grant a dangerous
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            // the user can paste it into `droidjig config` (companion_token), and copy on tap.
            ...
            pairing.addPreference(
                Preference(ctx).apply {
                    ...
                    setOnPreferenceClickListener {
                        ...
                        clip.setPrimaryClip(
                            ClipData.newPlainText("droidjig companion_token", state.companionToken()))
