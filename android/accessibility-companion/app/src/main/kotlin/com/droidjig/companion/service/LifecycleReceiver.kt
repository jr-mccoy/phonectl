...
class LifecycleReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        // SET_TOKEN uses trust-on-first-use: adopt a droidjig-minted token ONLY when none is set
    ...
    companion object {
        const val ACTION_START = "com.droidjig.companion.action.START_SERVICE"
        const val ACTION_STOP = "com.droidjig.companion.action.STOP_SERVICE"

        /** Trust-on-first-use pairing (pushed-token v2): adopt a minted token when none is set. */
        const val ACTION_SET_TOKEN = "com.droidjig.companion.action.SET_TOKEN"
