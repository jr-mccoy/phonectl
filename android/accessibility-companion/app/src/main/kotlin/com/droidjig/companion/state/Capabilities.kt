 ...
 *
 * These are exactly the keys the Python side recognizes (src/droidjig/capabilities.py) for the
...
object Capabilities {
     ...
     * usable immediately after `droidjig companion setup`.
     *
    ...
    /**
     * A per-method gate for [com.droidjig.companion.transport.Dispatcher]: returns
