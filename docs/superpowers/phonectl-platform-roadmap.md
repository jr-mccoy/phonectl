...
| **6** | Macro runtime & progressive autonomy | **Spec 6.0** macro engine spec · **6.1** macro runtime core · **6.2** triggers + scheduler · **6.3** progressive autonomy + memory/state layer | strategy §12, §18, §23, §25 |
