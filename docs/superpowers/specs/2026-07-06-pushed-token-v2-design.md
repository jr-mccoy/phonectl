...
**Status:** code-complete, **NOT device-validated**, security-review owed before enabling for
release builds. Companion-setup follow-up #2 (`docs/superpowers/plans/2026-07-02-companion-startup-followups.md`).
